# Email Network Graph Analysis

An empirical network science project analyzing the internal email communication topology of a large European research institution using the `email-Eu-core` dataset.
